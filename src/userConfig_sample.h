...
#define FEATURE_HOTWATERSWITCH 0                       // 0 = deactivated, 1 = activated
#define HOTWATERSWITCH_TYPE    Switch::TOGGLE          // Switch::TOGGLE or Switch::MOMENTARY (trigger)
#define HOTWATERSWITCH_MODE    Switch::NORMALLY_OPEN   // Switch::NORMALLY_OPEN or Switch::NORMALLY_CLOSED
