...
#define FEATURE_STATUS_LED     0                     // Turn on status LED when temp is in range, 0 = deactivated, 1 = activated, 2 = blink while temp is not in range, activate once temp in range
