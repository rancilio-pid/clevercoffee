...
#define RGB_LED_TYPE WS2811        // In case of an RGB LED so TEMP_LED==2, state type of LED (NEOPIXEL, WS2811, TM1809, ...)
#define NUM_LEDS 4                 // Number of LEDs attached, one also OK - not considered if TEMP_LED above is zero
