...
#include "rancilio-pid.h"
    ...
    hw_timer_t *timer = NULL;
        ...
        ClickEncoder encoder{ENCODER_PINA, ENCODER_PINB, ENCODER_BTN, ENCODER_CLICKS_PER_NOTCH, LOW};
        int last = 0;
...
void setup() {
    ...
    if (PINBREWSWITCH > 0 && BREWDETECTION != 3) {
        ...
        pinMode(ENCODER_PINA, INPUT_PULLDOWN);
        pinMode(ENCODER_PINB, INPUT_PULLDOWN);
