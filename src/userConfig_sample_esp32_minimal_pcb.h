...
#define PINPRESSURESENSOR 23       // Pressure sensor 
#define PINPOWERSWITCH 39          // Input pin for powerswitch (use a pin which is LOW on startup or use an pull down resistor)
#define PINVALVE 17
#define PINPUMP 27
#define PINHEATER 2
#define PINVOLTAGESENSOR 99        // Input pin for voltage sensor (optocoupler to detect brew switch); Use PINBREWSWITCH if you use optocoupler
#define PINETRIGGER 25             // PIN for E-Trigger relay
#define PINBREWSWITCH 34           
#define PINSTEAMSWITCH 35
#define LEDPIN 26                  // LED PIN ON near setpoint
#define OLED_SCL 22                // Output pin for display clock pin
#define OLED_SDA 21                // Output pin for display data pin
#define HXDATPIN 32                // weight scale data pin
#define HXCLKPIN 33                // weight scale clock pin
